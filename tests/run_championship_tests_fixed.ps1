...
function Invoke-PhaseTests {
    ...
    # Phase 1: Swiss Pairings and Elimination Brackets (Unit Tests)
    if (-not $SkipUnit) {
        Write-Host "`n🏆 Phase 1: Swiss Pairings and Elimination Brackets" -ForegroundColor Cyan
        Write-Host "-------------------------------------------------" -ForegroundColor Cyan
    ...
    # Phase 2: Match Scheduling and Invitations (Feature Tests)
    if (-not $SkipFeature) {
        Write-Host "`n📅 Phase 2: Match Scheduling and Invitations" -ForegroundColor Cyan
        Write-Host "-------------------------------------------" -ForegroundColor Cyan
    ...
    # Phase 3: Tournament Workflow Integration
...
try {
    ...
    Write-Host "Phase 1: Swiss Pairings and Elimination Brackets" -ForegroundColor White
    Write-Host "Phase 2: Match Scheduling and Invitations" -ForegroundColor White
    Write-Host "Phase 3: WebSocket Events and Frontend Integration" -ForegroundColor White
    Write-Host ""
