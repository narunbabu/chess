        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="w-full max-w-sm rounded-xl border border-[#3d3a37] bg-[#262421] p-5 shadow-2xl">
            ...
            <p className="text-sm text-[#bababa] mb-5">
              Log in to play online, track your rating, and keep your game history — or jump into a quick casual game as a guest.
            </p>
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full rounded-lg border border-[#4a4744] bg-[#312e2b] px-4 py-2.5 text-white hover:bg-[#3d3a37] transition-colors"
              >
                <span className="block text-sm font-semibold">Play as Guest</span>
                <span className="block text-[11px] font-normal text-[#9b9895] mt-0.5">
                  Quick casual game — your rating &amp; progress won’t be saved
                </span>
              </button>
              <button
