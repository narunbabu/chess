...
const ChessKnight = ({ className = "", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
const ChessPawn = ({ className = "", ...props }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...props}>
...
const FloatingChessPiece = ({ Piece, delay = 0, duration = 6, ...props }) => (
  <div
