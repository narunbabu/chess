...
class AdminDashboardController extends Controller
{
    ...
    /**
     * Daily progress data for a single user (charts).
     *
     * GET /admin/dashboard/user/{id}/progress?period=30d
     */
    public function userProgress(Request $request, $id): JsonResponse
    {
        $id = (int) $id;
        $target = User::find($id);
        if (!$target) {
