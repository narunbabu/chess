...
class ChampionshipMatchInvitationDeclined implements ShouldBroadcastNow
{
    ...
    public function __construct(ChampionshipMatch $match, $declinedBy, $reason = null)
    {
    ...
    public function broadcastWith()
    {
        return [
            ...
            'message' => "Tournament invitation declined by {$this->declinedBy->name}" .
    ...
    {
        return 'championship.invitation.declined';
    }
}