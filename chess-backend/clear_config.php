...
echo "🗑️ Clearing Tournament Config and Regenerating\n";
echo str_repeat("=", 50) . "\n";
...
try {
    ...
    // Clear the tournament config
    $championship->tournament_config = null;
    $championship->save();

    echo "✅ Tournament config cleared\n";

    // Now get fresh config
    $config = $championship->getOrCreateTournamentConfig();

    echo "\n📋 Fresh Tournament Configuration:\n";
