...
start "Chess-Web Backend" cmd /k "cd /d D:\ArunApps\Chess-Web\chess-backend && php artisan serve"
timeout /t 3 /nobreak >nul

echo [2/3] Starting WebSocket Server...
start "Chess-Web WebSocket" cmd /k "cd /d D:\ArunApps\Chess-Web\chess-backend && php artisan reverb:start"
timeout /t 3 /nobreak >nul

echo [3/3] Starting Frontend Server...
start "Chess-Web Frontend" cmd /k "cd /d D:\ArunApps\Chess-Web\chess-frontend && npm run dev"
timeout /t 3 /nobreak >nul
