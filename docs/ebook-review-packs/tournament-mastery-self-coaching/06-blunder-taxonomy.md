# Review Pack: Blunder Taxonomy

Book: Tournament Mastery And Self-Coaching
Chapter: 06-blunder-taxonomy
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/06-blunder-taxonomy.json
Generated: 2026-05-05T07:36:04.028Z
...
Learning objectives:
- Recognize the visual signal for blunder taxonomy.
- Choose a move or plan that fits blunder taxonomy.
- Avoid the common beginner error connected with blunder taxonomy.
...
```text
Blunder Taxonomy is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c06-d01 - Training Diagram: main pattern
...
![b12-c06-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-d01-quiet-king.png)
...
### b12-c06-d02 - Training Diagram: candidate move
...
![b12-c06-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-d02-knight-fork.png)
...
### b12-c06-d03 - Training Diagram: comparison position
...
![b12-c06-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-d03-pin-file.png)
...
### b12-c06-d04 - Training Diagram: best practical choice
...
![b12-c06-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-d04-back-rank.png)
...
### b12-c06-d05 - Training Diagram: review position
...
![b12-c06-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-d05-bishop-wins-rook.png)
...
### b12-c06-g01 - Try It: Find The Training Move
...
![b12-c06-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-g01-quiet-king.png)
...
### b12-c06-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c06-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c06-m01-quiet-king.png)
...
### b12-c06-q01 - Blunder Taxonomy Check 1
...
```text
Blunder Taxonomy Check 1
What should you do first in a position about **blunder taxonomy**?
```
...
### b12-c06-q02 - Blunder Taxonomy Check 2
...
```text
Blunder Taxonomy Check 2
Which answer best matches the chapter habit for **blunder taxonomy**?
```
...
### b12-c06-q03 - Blunder Taxonomy Check 3
...
```text
Blunder Taxonomy Check 3
What is the biggest danger if you ignore **blunder taxonomy**?
```
