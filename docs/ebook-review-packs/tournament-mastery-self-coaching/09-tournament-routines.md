# Review Pack: Tournament Routines

Book: Tournament Mastery And Self-Coaching
Chapter: 09-tournament-routines
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/09-tournament-routines.json
Generated: 2026-05-05T07:36:04.037Z
...
Learning objectives:
- Recognize the visual signal for tournament routines.
- Choose a move or plan that fits tournament routines.
- Avoid the common beginner error connected with tournament routines.
...
```text
Tournament Routines is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c09-d01 - Training Diagram: main pattern
...
![b12-c09-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-d01-back-rank.png)
...
### b12-c09-d02 - Training Diagram: candidate move
...
![b12-c09-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-d02-bishop-wins-rook.png)
...
### b12-c09-d03 - Training Diagram: comparison position
...
![b12-c09-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-d03-queen-target.png)
...
### b12-c09-d04 - Training Diagram: best practical choice
...
![b12-c09-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-d04-castle-safety.png)
...
### b12-c09-d05 - Training Diagram: review position
...
![b12-c09-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-d05-cct-check.png)
...
### b12-c09-g01 - Try It: Find The Training Move
...
![b12-c09-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-g01-back-rank.png)
...
### b12-c09-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c09-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c09-m01-back-rank.png)
...
### b12-c09-q01 - Tournament Routines Check 1
...
```text
Tournament Routines Check 1
What should you do first in a position about **tournament routines**?
```
...
### b12-c09-q02 - Tournament Routines Check 2
...
```text
Tournament Routines Check 2
Which answer best matches the chapter habit for **tournament routines**?
```
...
### b12-c09-q03 - Tournament Routines Check 3
...
```text
Tournament Routines Check 3
What is the biggest danger if you ignore **tournament routines**?
```
