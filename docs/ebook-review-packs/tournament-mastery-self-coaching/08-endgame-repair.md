# Review Pack: Endgame Repair

Book: Tournament Mastery And Self-Coaching
Chapter: 08-endgame-repair
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/08-endgame-repair.json
Generated: 2026-05-05T07:36:04.034Z
...
Learning objectives:
- Recognize the visual signal for endgame repair.
- Choose a move or plan that fits endgame repair.
- Avoid the common beginner error connected with endgame repair.
...
```text
Endgame Repair is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c08-d01 - Training Diagram: main pattern
...
![b12-c08-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-d01-pin-file.png)
...
### b12-c08-d02 - Training Diagram: candidate move
...
![b12-c08-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-d02-back-rank.png)
...
### b12-c08-d03 - Training Diagram: comparison position
...
![b12-c08-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-d03-bishop-wins-rook.png)
...
### b12-c08-d04 - Training Diagram: best practical choice
...
![b12-c08-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-d04-queen-target.png)
...
### b12-c08-d05 - Training Diagram: review position
...
![b12-c08-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-d05-castle-safety.png)
...
### b12-c08-g01 - Try It: Find The Training Move
...
![b12-c08-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-g01-pin-file.png)
...
### b12-c08-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c08-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c08-m01-pin-file.png)
...
### b12-c08-q01 - Endgame Repair Check 1
...
```text
Endgame Repair Check 1
What should you do first in a position about **endgame repair**?
```
...
### b12-c08-q02 - Endgame Repair Check 2
...
```text
Endgame Repair Check 2
Which answer best matches the chapter habit for **endgame repair**?
```
...
### b12-c08-q03 - Endgame Repair Check 3
...
```text
Endgame Repair Check 3
What is the biggest danger if you ignore **endgame repair**?
```
