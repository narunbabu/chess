# Review Pack: Decision Journals

Book: Tournament Mastery And Self-Coaching
Chapter: 04-decision-journals
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/04-decision-journals.json
Generated: 2026-05-05T07:36:04.021Z
...
Learning objectives:
- Recognize the visual signal for decision journals.
- Choose a move or plan that fits decision journals.
- Avoid the common beginner error connected with decision journals.
...
```text
Decision Journals is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c04-d01 - Training Diagram: main pattern
...
![b12-c04-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-d01-rook-activity.png)
...
### b12-c04-d02 - Training Diagram: candidate move
...
![b12-c04-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-d02-king-pawn.png)
...
### b12-c04-d03 - Training Diagram: comparison position
...
![b12-c04-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-d03-quiet-king.png)
...
### b12-c04-d04 - Training Diagram: best practical choice
...
![b12-c04-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-d04-knight-fork.png)
...
### b12-c04-d05 - Training Diagram: review position
...
![b12-c04-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-d05-pin-file.png)
...
### b12-c04-g01 - Try It: Find The Training Move
...
![b12-c04-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-g01-rook-activity.png)
...
### b12-c04-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c04-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c04-m01-rook-activity.png)
...
### b12-c04-q01 - Decision Journals Check 1
...
```text
Decision Journals Check 1
What should you do first in a position about **decision journals**?
```
...
### b12-c04-q02 - Decision Journals Check 2
...
```text
Decision Journals Check 2
Which answer best matches the chapter habit for **decision journals**?
```
...
### b12-c04-q03 - Decision Journals Check 3
...
```text
Decision Journals Check 3
What is the biggest danger if you ignore **decision journals**?
```
