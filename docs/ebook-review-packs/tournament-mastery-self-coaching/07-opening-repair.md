# Review Pack: Opening Repair

Book: Tournament Mastery And Self-Coaching
Chapter: 07-opening-repair
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/07-opening-repair.json
Generated: 2026-05-05T07:36:04.031Z
...
Learning objectives:
- Recognize the visual signal for opening repair.
- Choose a move or plan that fits opening repair.
- Avoid the common beginner error connected with opening repair.
...
```text
Opening Repair is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c07-d01 - Training Diagram: main pattern
...
![b12-c07-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-d01-knight-fork.png)
...
### b12-c07-d02 - Training Diagram: candidate move
...
![b12-c07-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-d02-pin-file.png)
...
### b12-c07-d03 - Training Diagram: comparison position
...
![b12-c07-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-d03-back-rank.png)
...
### b12-c07-d04 - Training Diagram: best practical choice
...
![b12-c07-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-d04-bishop-wins-rook.png)
...
### b12-c07-d05 - Training Diagram: review position
...
![b12-c07-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-d05-queen-target.png)
...
### b12-c07-g01 - Try It: Find The Training Move
...
![b12-c07-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-g01-knight-fork.png)
...
### b12-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c07-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c07-m01-knight-fork.png)
...
### b12-c07-q01 - Opening Repair Check 1
...
```text
Opening Repair Check 1
What should you do first in a position about **opening repair**?
```
...
### b12-c07-q02 - Opening Repair Check 2
...
```text
Opening Repair Check 2
Which answer best matches the chapter habit for **opening repair**?
```
...
### b12-c07-q03 - Opening Repair Check 3
...
```text
Opening Repair Check 3
What is the biggest danger if you ignore **opening repair**?
```
