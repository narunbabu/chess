# Review Pack: Pre-Game Preparation

Book: Tournament Mastery And Self-Coaching
Chapter: 01-pre-game-preparation
Source: ../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/chapters/01-pre-game-preparation.json
Generated: 2026-05-05T07:36:04.010Z
...
Learning objectives:
- Recognize the visual signal for pre-game preparation.
- Choose a move or plan that fits pre-game preparation.
- Avoid the common beginner error connected with pre-game preparation.
...
```text
Pre-Game Preparation is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b12-c01-d01 - Training Diagram: main pattern
...
![b12-c01-d01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-d01-queen-target.png)
...
### b12-c01-d02 - Training Diagram: candidate move
...
![b12-c01-d02](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-d02-castle-safety.png)
...
### b12-c01-d03 - Training Diagram: comparison position
...
![b12-c01-d03](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-d03-cct-check.png)
...
### b12-c01-d04 - Training Diagram: best practical choice
...
![b12-c01-d04](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-d04-rook-activity.png)
...
### b12-c01-d05 - Training Diagram: review position
...
![b12-c01-d05](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-d05-king-pawn.png)
...
### b12-c01-g01 - Try It: Find The Training Move
...
![b12-c01-g01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-g01-queen-target.png)
...
### b12-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b12-c01-m01](../../../chess-frontend/src/data/ebooks/v2/tournament-mastery-self-coaching/assets/diagrams/b12-c01-m01-queen-target.png)
...
### b12-c01-q01 - Pre-Game Preparation Check 1
...
```text
Pre-Game Preparation Check 1
What should you do first in a position about **pre-game preparation**?
```
...
### b12-c01-q02 - Pre-Game Preparation Check 2
...
```text
Pre-Game Preparation Check 2
Which answer best matches the chapter habit for **pre-game preparation**?
```
...
### b12-c01-q03 - Pre-Game Preparation Check 3
...
```text
Pre-Game Preparation Check 3
What is the biggest danger if you ignore **pre-game preparation**?
```
