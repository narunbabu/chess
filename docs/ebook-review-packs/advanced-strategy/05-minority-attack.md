# Review Pack: Minority Attack

Book: Advanced Strategy
Chapter: 05-minority-attack
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/05-minority-attack.json
Generated: 2026-05-05T07:36:03.601Z
...
Learning objectives:
- Recognize the visual signal for minority attack.
- Choose a move or plan that fits minority attack.
- Avoid the common beginner error connected with minority attack.
...
```text
Minority Attack is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c05-d01 - Training Diagram: main pattern
...
![b09-c05-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-d01-rook-activity.png)
...
### b09-c05-d02 - Training Diagram: candidate move
...
![b09-c05-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-d02-king-pawn.png)
...
### b09-c05-d03 - Training Diagram: comparison position
...
![b09-c05-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-d03-quiet-king.png)
...
### b09-c05-d04 - Training Diagram: best practical choice
...
![b09-c05-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-d04-knight-fork.png)
...
### b09-c05-d05 - Training Diagram: review position
...
![b09-c05-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-d05-pin-file.png)
...
### b09-c05-g01 - Try It: Find The Training Move
...
![b09-c05-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-g01-rook-activity.png)
...
### b09-c05-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c05-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c05-m01-rook-activity.png)
...
### b09-c05-q01 - Minority Attack Check 1
...
```text
Minority Attack Check 1
What should you do first in a position about **minority attack**?
```
...
### b09-c05-q02 - Minority Attack Check 2
...
```text
Minority Attack Check 2
Which answer best matches the chapter habit for **minority attack**?
```
...
### b09-c05-q03 - Minority Attack Check 3
...
```text
Minority Attack Check 3
What is the biggest danger if you ignore **minority attack**?
```
