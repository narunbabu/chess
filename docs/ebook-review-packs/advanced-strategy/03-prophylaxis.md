# Review Pack: Prophylaxis

Book: Advanced Strategy
Chapter: 03-prophylaxis
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/03-prophylaxis.json
Generated: 2026-05-05T07:36:03.592Z
...
Learning objectives:
- Recognize the visual signal for prophylaxis.
- Choose a move or plan that fits prophylaxis.
- Avoid the common beginner error connected with prophylaxis.
...
```text
Prophylaxis is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c03-d01 - Training Diagram: main pattern
...
![b09-c03-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-d01-castle-safety.png)
...
### b09-c03-d02 - Training Diagram: candidate move
...
![b09-c03-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-d02-cct-check.png)
...
### b09-c03-d03 - Training Diagram: comparison position
...
![b09-c03-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-d03-rook-activity.png)
...
### b09-c03-d04 - Training Diagram: best practical choice
...
![b09-c03-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-d04-king-pawn.png)
...
### b09-c03-d05 - Training Diagram: review position
...
![b09-c03-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-d05-quiet-king.png)
...
### b09-c03-g01 - Try It: Find The Training Move
...
![b09-c03-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-g01-castle-safety.png)
...
### b09-c03-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c03-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c03-m01-castle-safety.png)
...
### b09-c03-q01 - Prophylaxis Check 1
...
```text
Prophylaxis Check 1
What should you do first in a position about **prophylaxis**?
```
...
### b09-c03-q02 - Prophylaxis Check 2
...
```text
Prophylaxis Check 2
Which answer best matches the chapter habit for **prophylaxis**?
```
...
### b09-c03-q03 - Prophylaxis Check 3
...
```text
Prophylaxis Check 3
What is the biggest danger if you ignore **prophylaxis**?
```
