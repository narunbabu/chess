# Review Pack: Static Vs Dynamic Advantages

Book: Advanced Strategy
Chapter: 02-static-vs-dynamic-advantages
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/02-static-vs-dynamic-advantages.json
Generated: 2026-05-05T07:36:03.586Z
...
Learning objectives:
- Recognize the visual signal for static vs dynamic advantages.
- Choose a move or plan that fits static vs dynamic advantages.
- Avoid the common beginner error connected with static vs dynamic advantages.
...
```text
Static Vs Dynamic Advantages is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c02-d01 - Training Diagram: main pattern
...
![b09-c02-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-d01-queen-target.png)
...
### b09-c02-d02 - Training Diagram: candidate move
...
![b09-c02-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-d02-castle-safety.png)
...
### b09-c02-d03 - Training Diagram: comparison position
...
![b09-c02-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-d03-cct-check.png)
...
### b09-c02-d04 - Training Diagram: best practical choice
...
![b09-c02-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-d04-rook-activity.png)
...
### b09-c02-d05 - Training Diagram: review position
...
![b09-c02-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-d05-king-pawn.png)
...
### b09-c02-g01 - Try It: Find The Training Move
...
![b09-c02-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-g01-queen-target.png)
...
### b09-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c02-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c02-m01-queen-target.png)
...
### b09-c02-q01 - Static Vs Dynamic Advantages Check 1
...
```text
Static Vs Dynamic Advantages Check 1
What should you do first in a position about **static vs dynamic advantages**?
```
...
### b09-c02-q02 - Static Vs Dynamic Advantages Check 2
...
```text
Static Vs Dynamic Advantages Check 2
Which answer best matches the chapter habit for **static vs dynamic advantages**?
```
...
### b09-c02-q03 - Static Vs Dynamic Advantages Check 3
...
```text
Static Vs Dynamic Advantages Check 3
What is the biggest danger if you ignore **static vs dynamic advantages**?
```
