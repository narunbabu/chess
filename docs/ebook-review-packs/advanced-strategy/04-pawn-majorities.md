# Review Pack: Pawn Majorities

Book: Advanced Strategy
Chapter: 04-pawn-majorities
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/04-pawn-majorities.json
Generated: 2026-05-05T07:36:03.596Z
...
Learning objectives:
- Recognize the visual signal for pawn majorities.
- Choose a move or plan that fits pawn majorities.
- Avoid the common beginner error connected with pawn majorities.
...
```text
Pawn Majorities is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c04-d01 - Training Diagram: main pattern
...
![b09-c04-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-d01-cct-check.png)
...
### b09-c04-d02 - Training Diagram: candidate move
...
![b09-c04-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-d02-rook-activity.png)
...
### b09-c04-d03 - Training Diagram: comparison position
...
![b09-c04-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-d03-king-pawn.png)
...
### b09-c04-d04 - Training Diagram: best practical choice
...
![b09-c04-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-d04-quiet-king.png)
...
### b09-c04-d05 - Training Diagram: review position
...
![b09-c04-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-d05-knight-fork.png)
...
### b09-c04-g01 - Try It: Find The Training Move
...
![b09-c04-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-g01-cct-check.png)
...
### b09-c04-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c04-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c04-m01-cct-check.png)
...
### b09-c04-q01 - Pawn Majorities Check 1
...
```text
Pawn Majorities Check 1
What should you do first in a position about **pawn majorities**?
```
...
### b09-c04-q02 - Pawn Majorities Check 2
...
```text
Pawn Majorities Check 2
Which answer best matches the chapter habit for **pawn majorities**?
```
...
### b09-c04-q03 - Pawn Majorities Check 3
...
```text
Pawn Majorities Check 3
What is the biggest danger if you ignore **pawn majorities**?
```
