# Review Pack: Imbalances

Book: Advanced Strategy
Chapter: 01-imbalances
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/01-imbalances.json
Generated: 2026-05-05T07:36:03.580Z
...
Learning objectives:
- Recognize the visual signal for imbalances.
- Choose a move or plan that fits imbalances.
- Avoid the common beginner error connected with imbalances.
...
```text
Imbalances is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c01-d01 - Training Diagram: main pattern
...
![b09-c01-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-d01-bishop-wins-rook.png)
...
### b09-c01-d02 - Training Diagram: candidate move
...
![b09-c01-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-d02-queen-target.png)
...
### b09-c01-d03 - Training Diagram: comparison position
...
![b09-c01-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-d03-castle-safety.png)
...
### b09-c01-d04 - Training Diagram: best practical choice
...
![b09-c01-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-d04-cct-check.png)
...
### b09-c01-d05 - Training Diagram: review position
...
![b09-c01-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-d05-rook-activity.png)
...
### b09-c01-g01 - Try It: Find The Training Move
...
![b09-c01-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-g01-bishop-wins-rook.png)
...
### b09-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c01-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c01-m01-bishop-wins-rook.png)
...
### b09-c01-q01 - Imbalances Check 1
...
```text
Imbalances Check 1
What should you do first in a position about **imbalances**?
```
...
### b09-c01-q02 - Imbalances Check 2
...
```text
Imbalances Check 2
Which answer best matches the chapter habit for **imbalances**?
```
...
### b09-c01-q03 - Imbalances Check 3
...
```text
Imbalances Check 3
What is the biggest danger if you ignore **imbalances**?
```
