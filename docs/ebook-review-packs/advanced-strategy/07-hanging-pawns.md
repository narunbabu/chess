# Review Pack: Hanging Pawns

Book: Advanced Strategy
Chapter: 07-hanging-pawns
Source: ../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/chapters/07-hanging-pawns.json
Generated: 2026-05-05T07:36:03.609Z
...
Learning objectives:
- Recognize the visual signal for hanging pawns.
- Choose a move or plan that fits hanging pawns.
- Avoid the common beginner error connected with hanging pawns.
...
```text
Hanging Pawns is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b09-c07-d01 - Training Diagram: main pattern
...
![b09-c07-d01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-d01-quiet-king.png)
...
### b09-c07-d02 - Training Diagram: candidate move
...
![b09-c07-d02](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-d02-knight-fork.png)
...
### b09-c07-d03 - Training Diagram: comparison position
...
![b09-c07-d03](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-d03-pin-file.png)
...
### b09-c07-d04 - Training Diagram: best practical choice
...
![b09-c07-d04](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-d04-back-rank.png)
...
### b09-c07-d05 - Training Diagram: review position
...
![b09-c07-d05](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-d05-bishop-wins-rook.png)
...
### b09-c07-g01 - Try It: Find The Training Move
...
![b09-c07-g01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-g01-quiet-king.png)
...
### b09-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b09-c07-m01](../../../chess-frontend/src/data/ebooks/v2/advanced-strategy/assets/diagrams/b09-c07-m01-quiet-king.png)
...
### b09-c07-q01 - Hanging Pawns Check 1
...
```text
Hanging Pawns Check 1
What should you do first in a position about **hanging pawns**?
```
...
### b09-c07-q02 - Hanging Pawns Check 2
...
```text
Hanging Pawns Check 2
Which answer best matches the chapter habit for **hanging pawns**?
```
...
### b09-c07-q03 - Hanging Pawns Check 3
...
```text
Hanging Pawns Check 3
What is the biggest danger if you ignore **hanging pawns**?
```
