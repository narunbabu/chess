# Review Pack: Interference

Book: Club Tactics
Chapter: 06-interference
Source: ../../../chess-frontend/src/data/ebooks/v2/club-tactics/chapters/06-interference.json
Generated: 2026-05-05T07:36:03.807Z
...
Learning objectives:
- Recognize the visual signal for interference.
- Choose a move or plan that fits interference.
- Avoid the common beginner error connected with interference.
...
```text
Interference is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b06-c06-d01 - Training Diagram: main pattern
...
![b06-c06-d01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-d01-rook-activity.png)
...
### b06-c06-d02 - Training Diagram: candidate move
...
![b06-c06-d02](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-d02-king-pawn.png)
...
### b06-c06-d03 - Training Diagram: comparison position
...
![b06-c06-d03](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-d03-quiet-king.png)
...
### b06-c06-d04 - Training Diagram: best practical choice
...
![b06-c06-d04](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-d04-knight-fork.png)
...
### b06-c06-d05 - Training Diagram: review position
...
![b06-c06-d05](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-d05-pin-file.png)
...
### b06-c06-g01 - Try It: Find The Training Move
...
![b06-c06-g01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-g01-rook-activity.png)
...
### b06-c06-m01 - Common Mistake: Missing The Diagram Signal
...
![b06-c06-m01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c06-m01-rook-activity.png)
...
### b06-c06-q01 - Interference Check 1
...
What should you do first in a position about **interference**?
```
...
### b06-c06-q02 - Interference Check 2
...
```text
Interference Check 2
Which answer best matches the chapter habit for **interference**?
```
...
### b06-c06-q03 - Interference Check 3
...
What is the biggest danger if you ignore **interference**?
```
