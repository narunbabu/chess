# Review Pack: Overloaded Defenders

Book: Club Tactics
Chapter: 02-overloaded-defenders
Source: ../../../chess-frontend/src/data/ebooks/v2/club-tactics/chapters/02-overloaded-defenders.json
Generated: 2026-05-05T07:36:03.792Z
...
Learning objectives:
- Recognize the visual signal for overloaded defenders.
- Choose a move or plan that fits overloaded defenders.
- Avoid the common beginner error connected with overloaded defenders.
...
```text
Overloaded Defenders is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b06-c02-d01 - Training Diagram: main pattern
...
![b06-c02-d01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-d01-bishop-wins-rook.png)
...
### b06-c02-d02 - Training Diagram: candidate move
...
![b06-c02-d02](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-d02-queen-target.png)
...
### b06-c02-d03 - Training Diagram: comparison position
...
![b06-c02-d03](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-d03-castle-safety.png)
...
### b06-c02-d04 - Training Diagram: best practical choice
...
![b06-c02-d04](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-d04-cct-check.png)
...
### b06-c02-d05 - Training Diagram: review position
...
![b06-c02-d05](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-d05-rook-activity.png)
...
### b06-c02-g01 - Try It: Find The Training Move
...
![b06-c02-g01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-g01-bishop-wins-rook.png)
...
### b06-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b06-c02-m01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c02-m01-bishop-wins-rook.png)
...
### b06-c02-q01 - Overloaded Defenders Check 1
...
```text
Overloaded Defenders Check 1
What should you do first in a position about **overloaded defenders**?
```
...
### b06-c02-q02 - Overloaded Defenders Check 2
...
```text
Overloaded Defenders Check 2
Which answer best matches the chapter habit for **overloaded defenders**?
```
...
### b06-c02-q03 - Overloaded Defenders Check 3
...
```text
Overloaded Defenders Check 3
What is the biggest danger if you ignore **overloaded defenders**?
```
