# Review Pack: Sacrifices On f7 And h7

Book: Club Tactics
Chapter: 07-sacrifices-on-f7-and-h7
Source: ../../../chess-frontend/src/data/ebooks/v2/club-tactics/chapters/07-sacrifices-on-f7-and-h7.json
Generated: 2026-05-05T07:36:03.811Z
...
Learning objectives:
- Recognize the visual signal for sacrifices on f7 and h7.
- Choose a move or plan that fits sacrifices on f7 and h7.
- Avoid the common beginner error connected with sacrifices on f7 and h7.
...
```text
Sacrifices On f7 And h7 is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b06-c07-d01 - Training Diagram: main pattern
...
![b06-c07-d01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-d01-king-pawn.png)
...
### b06-c07-d02 - Training Diagram: candidate move
...
![b06-c07-d02](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-d02-quiet-king.png)
...
### b06-c07-d03 - Training Diagram: comparison position
...
![b06-c07-d03](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-d03-knight-fork.png)
...
### b06-c07-d04 - Training Diagram: best practical choice
...
![b06-c07-d04](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-d04-pin-file.png)
...
### b06-c07-d05 - Training Diagram: review position
...
![b06-c07-d05](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-d05-back-rank.png)
...
### b06-c07-g01 - Try It: Find The Training Move
...
![b06-c07-g01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-g01-king-pawn.png)
...
### b06-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b06-c07-m01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c07-m01-king-pawn.png)
...
### b06-c07-q01 - Sacrifices On f7 And h7 Check 1
...
```text
Sacrifices On f7 And h7 Check 1
What should you do first in a position about **sacrifices on f7 and h7**?
```
...
### b06-c07-q02 - Sacrifices On f7 And h7 Check 2
...
```text
Sacrifices On f7 And h7 Check 2
Which answer best matches the chapter habit for **sacrifices on f7 and h7**?
```
...
### b06-c07-q03 - Sacrifices On f7 And h7 Check 3
...
```text
Sacrifices On f7 And h7 Check 3
What is the biggest danger if you ignore **sacrifices on f7 and h7**?
```
