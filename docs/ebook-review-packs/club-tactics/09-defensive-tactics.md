# Review Pack: Defensive Tactics

Book: Club Tactics
Chapter: 09-defensive-tactics
Source: ../../../chess-frontend/src/data/ebooks/v2/club-tactics/chapters/09-defensive-tactics.json
Generated: 2026-05-05T07:36:03.817Z
...
Learning objectives:
- Recognize the visual signal for defensive tactics.
- Choose a move or plan that fits defensive tactics.
- Avoid the common beginner error connected with defensive tactics.
...
```text
Defensive Tactics is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b06-c09-d01 - Training Diagram: main pattern
...
![b06-c09-d01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-d01-knight-fork.png)
...
### b06-c09-d02 - Training Diagram: candidate move
...
![b06-c09-d02](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-d02-pin-file.png)
...
### b06-c09-d03 - Training Diagram: comparison position
...
![b06-c09-d03](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-d03-back-rank.png)
...
### b06-c09-d04 - Training Diagram: best practical choice
...
![b06-c09-d04](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-d04-bishop-wins-rook.png)
...
### b06-c09-d05 - Training Diagram: review position
...
![b06-c09-d05](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-d05-queen-target.png)
...
### b06-c09-g01 - Try It: Find The Training Move
...
![b06-c09-g01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-g01-knight-fork.png)
...
### b06-c09-m01 - Common Mistake: Missing The Diagram Signal
...
![b06-c09-m01](../../../chess-frontend/src/data/ebooks/v2/club-tactics/assets/diagrams/b06-c09-m01-knight-fork.png)
...
### b06-c09-q01 - Defensive Tactics Check 1
...
```text
Defensive Tactics Check 1
What should you do first in a position about **defensive tactics**?
```
...
### b06-c09-q02 - Defensive Tactics Check 2
...
```text
Defensive Tactics Check 2
Which answer best matches the chapter habit for **defensive tactics**?
```
...
### b06-c09-q03 - Defensive Tactics Check 3
...
```text
Defensive Tactics Check 3
What is the biggest danger if you ignore **defensive tactics**?
```
