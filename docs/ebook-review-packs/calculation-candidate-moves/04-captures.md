# Review Pack: Captures

Book: Calculation I - Candidate Moves
Chapter: 04-captures
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/chapters/04-captures.json
Generated: 2026-05-05T07:36:03.725Z
...
Learning objectives:
- Recognize the visual signal for captures.
- Choose a move or plan that fits captures.
- Avoid the common beginner error connected with captures.
...
```text
Captures is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b05-c04-d01 - Training Diagram: main pattern
...
![b05-c04-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-d01-king-pawn.png)
...
### b05-c04-d02 - Training Diagram: candidate move
...
![b05-c04-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-d02-quiet-king.png)
...
### b05-c04-d03 - Training Diagram: comparison position
...
![b05-c04-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-d03-knight-fork.png)
...
### b05-c04-d04 - Training Diagram: best practical choice
...
![b05-c04-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-d04-pin-file.png)
...
### b05-c04-d05 - Training Diagram: review position
...
![b05-c04-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-d05-back-rank.png)
...
### b05-c04-g01 - Try It: Find The Training Move
...
![b05-c04-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-g01-king-pawn.png)
...
### b05-c04-m01 - Common Mistake: Missing The Diagram Signal
...
![b05-c04-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c04-m01-king-pawn.png)
...
```text
Captures Check 1
What should you do first in a position about **captures**?
```
...
```text
Captures Check 2
Which answer best matches the chapter habit for **captures**?
```
...
```text
Captures Check 3
What is the biggest danger if you ignore **captures**?
```
