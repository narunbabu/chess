# Review Pack: Candidate Moves

Book: Calculation I - Candidate Moves
Chapter: 01-candidate-moves
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/chapters/01-candidate-moves.json
Generated: 2026-05-05T07:36:03.714Z
...
Learning objectives:
- Recognize the visual signal for candidate moves.
- Choose a move or plan that fits candidate moves.
- Avoid the common beginner error connected with candidate moves.
...
```text
Candidate Moves is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b05-c01-d01 - Training Diagram: main pattern
...
![b05-c01-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-d01-castle-safety.png)
...
### b05-c01-d02 - Training Diagram: candidate move
...
![b05-c01-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-d02-cct-check.png)
...
### b05-c01-d03 - Training Diagram: comparison position
...
![b05-c01-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-d03-rook-activity.png)
...
### b05-c01-d04 - Training Diagram: best practical choice
...
![b05-c01-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-d04-king-pawn.png)
...
### b05-c01-d05 - Training Diagram: review position
...
![b05-c01-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-d05-quiet-king.png)
...
### b05-c01-g01 - Try It: Find The Training Move
...
![b05-c01-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-g01-castle-safety.png)
...
### b05-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b05-c01-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c01-m01-castle-safety.png)
...
### b05-c01-q01 - Candidate Moves Check 1
...
```text
Candidate Moves Check 1
What should you do first in a position about **candidate moves**?
```
...
### b05-c01-q02 - Candidate Moves Check 2
...
```text
Candidate Moves Check 2
Which answer best matches the chapter habit for **candidate moves**?
```
...
### b05-c01-q03 - Candidate Moves Check 3
...
```text
Candidate Moves Check 3
What is the biggest danger if you ignore **candidate moves**?
```
