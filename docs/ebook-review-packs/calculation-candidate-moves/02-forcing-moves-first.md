# Review Pack: Forcing Moves First

Book: Calculation I - Candidate Moves
Chapter: 02-forcing-moves-first
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/chapters/02-forcing-moves-first.json
Generated: 2026-05-05T07:36:03.718Z
...
Learning objectives:
- Recognize the visual signal for forcing moves first.
- Choose a move or plan that fits forcing moves first.
- Avoid the common beginner error connected with forcing moves first.
...
```text
Forcing Moves First is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b05-c02-d01 - Training Diagram: main pattern
...
![b05-c02-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-d01-cct-check.png)
...
### b05-c02-d02 - Training Diagram: candidate move
...
![b05-c02-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-d02-rook-activity.png)
...
### b05-c02-d03 - Training Diagram: comparison position
...
![b05-c02-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-d03-king-pawn.png)
...
### b05-c02-d04 - Training Diagram: best practical choice
...
![b05-c02-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-d04-quiet-king.png)
...
### b05-c02-d05 - Training Diagram: review position
...
![b05-c02-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-d05-knight-fork.png)
...
### b05-c02-g01 - Try It: Find The Training Move
...
![b05-c02-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-g01-cct-check.png)
...
### b05-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b05-c02-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c02-m01-cct-check.png)
...
### b05-c02-q01 - Forcing Moves First Check 1
...
```text
Forcing Moves First Check 1
What should you do first in a position about **forcing moves first**?
```
...
### b05-c02-q02 - Forcing Moves First Check 2
...
```text
Forcing Moves First Check 2
Which answer best matches the chapter habit for **forcing moves first**?
```
...
### b05-c02-q03 - Forcing Moves First Check 3
...
```text
Forcing Moves First Check 3
What is the biggest danger if you ignore **forcing moves first**?
```
