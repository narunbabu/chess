...
Chapter: 05-threats
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/chapters/05-threats.json
Generated: 2026-05-05T07:36:03.728Z
...
Learning objectives:
- Recognize the visual signal for threats.
- Choose a move or plan that fits threats.
- Avoid the common beginner error connected with threats.
...
```text
Threats is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b05-c05-d01 - Training Diagram: main pattern
...
![b05-c05-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-d01-quiet-king.png)
...
### b05-c05-d02 - Training Diagram: candidate move
...
![b05-c05-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-d02-knight-fork.png)
...
### b05-c05-d03 - Training Diagram: comparison position
...
![b05-c05-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-d03-pin-file.png)
...
### b05-c05-d04 - Training Diagram: best practical choice
...
![b05-c05-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-d04-back-rank.png)
...
### b05-c05-d05 - Training Diagram: review position
...
![b05-c05-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-d05-bishop-wins-rook.png)
...
### b05-c05-g01 - Try It: Find The Training Move
...
![b05-c05-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-g01-quiet-king.png)
...
### b05-c05-m01 - Common Mistake: Missing The Diagram Signal
...
![b05-c05-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c05-m01-quiet-king.png)
...
```text
Threats Check 1
What should you do first in a position about **threats**?
```
...
```text
Threats Check 2
Which answer best matches the chapter habit for **threats**?
```
...
```text
Threats Check 3
What is the biggest danger if you ignore **threats**?
```
