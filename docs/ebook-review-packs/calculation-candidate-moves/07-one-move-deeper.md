# Review Pack: One Move Deeper

Book: Calculation I - Candidate Moves
Chapter: 07-one-move-deeper
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/chapters/07-one-move-deeper.json
Generated: 2026-05-05T07:36:03.735Z
...
Learning objectives:
- Recognize the visual signal for one move deeper.
- Choose a move or plan that fits one move deeper.
- Avoid the common beginner error connected with one move deeper.
...
```text
One Move Deeper is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b05-c07-d01 - Training Diagram: main pattern
...
![b05-c07-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-d01-pin-file.png)
...
### b05-c07-d02 - Training Diagram: candidate move
...
![b05-c07-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-d02-back-rank.png)
...
### b05-c07-d03 - Training Diagram: comparison position
...
![b05-c07-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-d03-bishop-wins-rook.png)
...
### b05-c07-d04 - Training Diagram: best practical choice
...
![b05-c07-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-d04-queen-target.png)
...
### b05-c07-d05 - Training Diagram: review position
...
![b05-c07-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-d05-castle-safety.png)
...
### b05-c07-g01 - Try It: Find The Training Move
...
![b05-c07-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-g01-pin-file.png)
...
### b05-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b05-c07-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-candidate-moves/assets/diagrams/b05-c07-m01-pin-file.png)
...
### b05-c07-q01 - One Move Deeper Check 1
...
```text
One Move Deeper Check 1
What should you do first in a position about **one move deeper**?
```
...
### b05-c07-q02 - One Move Deeper Check 2
...
```text
One Move Deeper Check 2
Which answer best matches the chapter habit for **one move deeper**?
```
...
### b05-c07-q03 - One Move Deeper Check 3
...
```text
One Move Deeper Check 3
What is the biggest danger if you ignore **one move deeper**?
```
