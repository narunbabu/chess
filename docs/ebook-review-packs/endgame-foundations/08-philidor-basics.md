# Review Pack: Philidor Basics

Book: Endgame Foundations
Chapter: 08-philidor-basics
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/08-philidor-basics.json
Generated: 2026-05-05T07:36:03.849Z
...
Learning objectives:
- Recognize the visual signal for philidor basics.
- Choose a move or plan that fits philidor basics.
- Avoid the common beginner error connected with philidor basics.
...
```text
Philidor Basics is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c08-d01 - Training Diagram: main pattern
...
![b08-c08-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-d01-bishop-wins-rook.png)
...
### b08-c08-d02 - Training Diagram: candidate move
...
![b08-c08-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-d02-queen-target.png)
...
### b08-c08-d03 - Training Diagram: comparison position
...
![b08-c08-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-d03-castle-safety.png)
...
### b08-c08-d04 - Training Diagram: best practical choice
...
![b08-c08-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-d04-cct-check.png)
...
### b08-c08-d05 - Training Diagram: review position
...
![b08-c08-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-d05-rook-activity.png)
...
### b08-c08-g01 - Try It: Find The Training Move
...
![b08-c08-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-g01-bishop-wins-rook.png)
...
### b08-c08-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c08-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c08-m01-bishop-wins-rook.png)
...
### b08-c08-q01 - Philidor Basics Check 1
...
```text
Philidor Basics Check 1
What should you do first in a position about **philidor basics**?
```
...
### b08-c08-q02 - Philidor Basics Check 2
...
```text
Philidor Basics Check 2
Which answer best matches the chapter habit for **philidor basics**?
```
...
### b08-c08-q03 - Philidor Basics Check 3
...
```text
Philidor Basics Check 3
What is the biggest danger if you ignore **philidor basics**?
```
