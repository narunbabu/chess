# Review Pack: Opposition

Book: Endgame Foundations
Chapter: 02-opposition
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/02-opposition.json
Generated: 2026-05-05T07:36:03.827Z
...
Learning objectives:
- Recognize the visual signal for opposition.
- Choose a move or plan that fits opposition.
- Avoid the common beginner error connected with opposition.
...
```text
Opposition is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c02-d01 - Training Diagram: main pattern
...
![b08-c02-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-d01-rook-activity.png)
...
### b08-c02-d02 - Training Diagram: candidate move
...
![b08-c02-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-d02-king-pawn.png)
...
### b08-c02-d03 - Training Diagram: comparison position
...
![b08-c02-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-d03-quiet-king.png)
...
### b08-c02-d04 - Training Diagram: best practical choice
...
![b08-c02-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-d04-knight-fork.png)
...
### b08-c02-d05 - Training Diagram: review position
...
![b08-c02-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-d05-pin-file.png)
...
### b08-c02-g01 - Try It: Find The Training Move
...
![b08-c02-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-g01-rook-activity.png)
...
### b08-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c02-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c02-m01-rook-activity.png)
...
### b08-c02-q01 - Opposition Check 1
...
```text
Opposition Check 1
What should you do first in a position about **opposition**?
```
...
### b08-c02-q02 - Opposition Check 2
...
```text
Opposition Check 2
Which answer best matches the chapter habit for **opposition**?
```
...
### b08-c02-q03 - Opposition Check 3
...
```text
Opposition Check 3
What is the biggest danger if you ignore **opposition**?
```
