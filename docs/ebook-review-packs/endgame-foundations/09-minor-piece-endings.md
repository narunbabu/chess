# Review Pack: Minor-Piece Endings

Book: Endgame Foundations
Chapter: 09-minor-piece-endings
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/09-minor-piece-endings.json
Generated: 2026-05-05T07:36:03.853Z
...
Learning objectives:
- Recognize the visual signal for minor-piece endings.
- Choose a move or plan that fits minor-piece endings.
- Avoid the common beginner error connected with minor-piece endings.
...
```text
Minor-Piece Endings is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c09-d01 - Training Diagram: main pattern
...
![b08-c09-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-d01-queen-target.png)
...
### b08-c09-d02 - Training Diagram: candidate move
...
![b08-c09-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-d02-castle-safety.png)
...
### b08-c09-d03 - Training Diagram: comparison position
...
![b08-c09-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-d03-cct-check.png)
...
### b08-c09-d04 - Training Diagram: best practical choice
...
![b08-c09-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-d04-rook-activity.png)
...
### b08-c09-d05 - Training Diagram: review position
...
![b08-c09-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-d05-king-pawn.png)
...
### b08-c09-g01 - Try It: Find The Training Move
...
![b08-c09-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-g01-queen-target.png)
...
### b08-c09-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c09-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c09-m01-queen-target.png)
...
### b08-c09-q01 - Minor-Piece Endings Check 1
...
```text
Minor-Piece Endings Check 1
What should you do first in a position about **minor-piece endings**?
```
...
### b08-c09-q02 - Minor-Piece Endings Check 2
...
```text
Minor-Piece Endings Check 2
Which answer best matches the chapter habit for **minor-piece endings**?
```
...
### b08-c09-q03 - Minor-Piece Endings Check 3
...
```text
Minor-Piece Endings Check 3
What is the biggest danger if you ignore **minor-piece endings**?
```
