# Review Pack: Key Squares

Book: Endgame Foundations
Chapter: 03-key-squares
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/03-key-squares.json
Generated: 2026-05-05T07:36:03.831Z
...
Learning objectives:
- Recognize the visual signal for key squares.
- Choose a move or plan that fits key squares.
- Avoid the common beginner error connected with key squares.
...
```text
Key Squares is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c03-d01 - Training Diagram: main pattern
...
![b08-c03-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-d01-king-pawn.png)
...
### b08-c03-d02 - Training Diagram: candidate move
...
![b08-c03-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-d02-quiet-king.png)
...
### b08-c03-d03 - Training Diagram: comparison position
...
![b08-c03-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-d03-knight-fork.png)
...
### b08-c03-d04 - Training Diagram: best practical choice
...
![b08-c03-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-d04-pin-file.png)
...
### b08-c03-d05 - Training Diagram: review position
...
![b08-c03-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-d05-back-rank.png)
...
### b08-c03-g01 - Try It: Find The Training Move
...
![b08-c03-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-g01-king-pawn.png)
...
### b08-c03-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c03-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c03-m01-king-pawn.png)
...
### b08-c03-q01 - Key Squares Check 1
...
```text
Key Squares Check 1
What should you do first in a position about **key squares**?
```
...
### b08-c03-q02 - Key Squares Check 2
...
```text
Key Squares Check 2
Which answer best matches the chapter habit for **key squares**?
```
...
### b08-c03-q03 - Key Squares Check 3
...
```text
Key Squares Check 3
What is the biggest danger if you ignore **key squares**?
```
