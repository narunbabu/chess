# Review Pack: Passed Pawns And The Square Rule

Book: Endgame Foundations
Chapter: 05-passed-pawns-and-the-square-rule
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/05-passed-pawns-and-the-square-rule.json
Generated: 2026-05-05T07:36:03.838Z
...
Learning objectives:
- Recognize the visual signal for passed pawns and the square rule.
- Choose a move or plan that fits passed pawns and the square rule.
- Avoid the common beginner error connected with passed pawns and the square rule.
...
```text
Passed Pawns And The Square Rule is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c05-d01 - Training Diagram: main pattern
...
![b08-c05-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-d01-knight-fork.png)
...
### b08-c05-d02 - Training Diagram: candidate move
...
![b08-c05-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-d02-pin-file.png)
...
### b08-c05-d03 - Training Diagram: comparison position
...
![b08-c05-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-d03-back-rank.png)
...
### b08-c05-d04 - Training Diagram: best practical choice
...
![b08-c05-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-d04-bishop-wins-rook.png)
...
### b08-c05-d05 - Training Diagram: review position
...
![b08-c05-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-d05-queen-target.png)
...
### b08-c05-g01 - Try It: Find The Training Move
...
![b08-c05-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-g01-knight-fork.png)
...
### b08-c05-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c05-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c05-m01-knight-fork.png)
...
### b08-c05-q01 - Passed Pawns And The Square Rule Check 1
...
```text
Passed Pawns And The Square Rule Check 1
What should you do first in a position about **passed pawns and the square rule**?
```
...
### b08-c05-q02 - Passed Pawns And The Square Rule Check 2
...
```text
Passed Pawns And The Square Rule Check 2
Which answer best matches the chapter habit for **passed pawns and the square rule**?
```
...
### b08-c05-q03 - Passed Pawns And The Square Rule Check 3
...
```text
Passed Pawns And The Square Rule Check 3
What is the biggest danger if you ignore **passed pawns and the square rule**?
```
