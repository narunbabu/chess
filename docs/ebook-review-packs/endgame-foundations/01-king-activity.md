# Review Pack: King Activity

Book: Endgame Foundations
Chapter: 01-king-activity
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/01-king-activity.json
Generated: 2026-05-05T07:36:03.824Z
...
Learning objectives:
- Recognize the visual signal for king activity.
- Choose a move or plan that fits king activity.
- Avoid the common beginner error connected with king activity.
...
```text
King Activity is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c01-d01 - Training Diagram: main pattern
...
![b08-c01-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-d01-cct-check.png)
...
### b08-c01-d02 - Training Diagram: candidate move
...
![b08-c01-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-d02-rook-activity.png)
...
### b08-c01-d03 - Training Diagram: comparison position
...
![b08-c01-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-d03-king-pawn.png)
...
### b08-c01-d04 - Training Diagram: best practical choice
...
![b08-c01-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-d04-quiet-king.png)
...
### b08-c01-d05 - Training Diagram: review position
...
![b08-c01-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-d05-knight-fork.png)
...
### b08-c01-g01 - Try It: Find The Training Move
...
![b08-c01-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-g01-cct-check.png)
...
### b08-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c01-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c01-m01-cct-check.png)
...
### b08-c01-q01 - King Activity Check 1
...
```text
King Activity Check 1
What should you do first in a position about **king activity**?
```
...
### b08-c01-q02 - King Activity Check 2
...
```text
King Activity Check 2
Which answer best matches the chapter habit for **king activity**?
```
...
### b08-c01-q03 - King Activity Check 3
...
```text
King Activity Check 3
What is the biggest danger if you ignore **king activity**?
```
