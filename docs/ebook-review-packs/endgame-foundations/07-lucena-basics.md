# Review Pack: Lucena Basics

Book: Endgame Foundations
Chapter: 07-lucena-basics
Source: ../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/chapters/07-lucena-basics.json
Generated: 2026-05-05T07:36:03.846Z
...
Learning objectives:
- Recognize the visual signal for lucena basics.
- Choose a move or plan that fits lucena basics.
- Avoid the common beginner error connected with lucena basics.
...
```text
Lucena Basics is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b08-c07-d01 - Training Diagram: main pattern
...
![b08-c07-d01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-d01-back-rank.png)
...
### b08-c07-d02 - Training Diagram: candidate move
...
![b08-c07-d02](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-d02-bishop-wins-rook.png)
...
### b08-c07-d03 - Training Diagram: comparison position
...
![b08-c07-d03](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-d03-queen-target.png)
...
### b08-c07-d04 - Training Diagram: best practical choice
...
![b08-c07-d04](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-d04-castle-safety.png)
...
### b08-c07-d05 - Training Diagram: review position
...
![b08-c07-d05](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-d05-cct-check.png)
...
### b08-c07-g01 - Try It: Find The Training Move
...
![b08-c07-g01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-g01-back-rank.png)
...
### b08-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b08-c07-m01](../../../chess-frontend/src/data/ebooks/v2/endgame-foundations/assets/diagrams/b08-c07-m01-back-rank.png)
...
### b08-c07-q01 - Lucena Basics Check 1
...
```text
Lucena Basics Check 1
What should you do first in a position about **lucena basics**?
```
...
### b08-c07-q02 - Lucena Basics Check 2
...
```text
Lucena Basics Check 2
Which answer best matches the chapter habit for **lucena basics**?
```
...
### b08-c07-q03 - Lucena Basics Check 3
...
```text
Lucena Basics Check 3
What is the biggest danger if you ignore **lucena basics**?
```
