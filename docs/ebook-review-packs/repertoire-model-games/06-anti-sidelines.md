# Review Pack: Anti-Sidelines

Book: Repertoire And Model Games
Chapter: 06-anti-sidelines
Source: ../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/chapters/06-anti-sidelines.json
Generated: 2026-05-05T07:36:03.960Z
...
Learning objectives:
- Recognize the visual signal for anti-sidelines.
- Choose a move or plan that fits anti-sidelines.
- Avoid the common beginner error connected with anti-sidelines.
...
```text
Anti-Sidelines is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b11-c06-d01 - Training Diagram: main pattern
...
![b11-c06-d01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-d01-back-rank.png)
...
### b11-c06-d02 - Training Diagram: candidate move
...
![b11-c06-d02](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-d02-bishop-wins-rook.png)
...
### b11-c06-d03 - Training Diagram: comparison position
...
![b11-c06-d03](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-d03-queen-target.png)
...
### b11-c06-d04 - Training Diagram: best practical choice
...
![b11-c06-d04](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-d04-castle-safety.png)
...
### b11-c06-d05 - Training Diagram: review position
...
![b11-c06-d05](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-d05-cct-check.png)
...
### b11-c06-g01 - Try It: Find The Training Move
...
![b11-c06-g01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-g01-back-rank.png)
...
### b11-c06-m01 - Common Mistake: Missing The Diagram Signal
...
![b11-c06-m01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c06-m01-back-rank.png)
...
### b11-c06-q01 - Anti-Sidelines Check 1
...
```text
Anti-Sidelines Check 1
What should you do first in a position about **anti-sidelines**?
```
...
### b11-c06-q02 - Anti-Sidelines Check 2
...
```text
Anti-Sidelines Check 2
Which answer best matches the chapter habit for **anti-sidelines**?
```
...
### b11-c06-q03 - Anti-Sidelines Check 3
...
```text
Anti-Sidelines Check 3
What is the biggest danger if you ignore **anti-sidelines**?
```
