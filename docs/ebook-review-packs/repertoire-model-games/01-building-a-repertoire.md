# Review Pack: Building A Repertoire

Book: Repertoire And Model Games
Chapter: 01-building-a-repertoire
Source: ../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/chapters/01-building-a-repertoire.json
Generated: 2026-05-05T07:36:03.945Z
...
Learning objectives:
- Recognize the visual signal for building a repertoire.
- Choose a move or plan that fits building a repertoire.
- Avoid the common beginner error connected with building a repertoire.
...
```text
Building A Repertoire is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b11-c01-d01 - Training Diagram: main pattern
...
![b11-c01-d01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-d01-rook-activity.png)
...
### b11-c01-d02 - Training Diagram: candidate move
...
![b11-c01-d02](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-d02-king-pawn.png)
...
### b11-c01-d03 - Training Diagram: comparison position
...
![b11-c01-d03](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-d03-quiet-king.png)
...
### b11-c01-d04 - Training Diagram: best practical choice
...
![b11-c01-d04](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-d04-knight-fork.png)
...
### b11-c01-d05 - Training Diagram: review position
...
![b11-c01-d05](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-d05-pin-file.png)
...
### b11-c01-g01 - Try It: Find The Training Move
...
![b11-c01-g01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-g01-rook-activity.png)
...
### b11-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b11-c01-m01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c01-m01-rook-activity.png)
...
### b11-c01-q01 - Building A Repertoire Check 1
...
```text
Building A Repertoire Check 1
What should you do first in a position about **building a repertoire**?
```
...
### b11-c01-q02 - Building A Repertoire Check 2
...
```text
Building A Repertoire Check 2
Which answer best matches the chapter habit for **building a repertoire**?
```
...
### b11-c01-q03 - Building A Repertoire Check 3
...
```text
Building A Repertoire Check 3
What is the biggest danger if you ignore **building a repertoire**?
```
