# Review Pack: Opening Mistakes And Punishments

Book: Repertoire And Model Games
Chapter: 08-opening-mistakes-and-punishments
Source: ../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/chapters/08-opening-mistakes-and-punishments.json
Generated: 2026-05-05T07:36:03.967Z
...
Learning objectives:
- Recognize the visual signal for opening mistakes and punishments.
- Choose a move or plan that fits opening mistakes and punishments.
- Avoid the common beginner error connected with opening mistakes and punishments.
...
```text
Opening Mistakes And Punishments is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b11-c08-d01 - Training Diagram: main pattern
...
![b11-c08-d01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-d01-queen-target.png)
...
### b11-c08-d02 - Training Diagram: candidate move
...
![b11-c08-d02](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-d02-castle-safety.png)
...
### b11-c08-d03 - Training Diagram: comparison position
...
![b11-c08-d03](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-d03-cct-check.png)
...
### b11-c08-d04 - Training Diagram: best practical choice
...
![b11-c08-d04](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-d04-rook-activity.png)
...
### b11-c08-d05 - Training Diagram: review position
...
![b11-c08-d05](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-d05-king-pawn.png)
...
### b11-c08-g01 - Try It: Find The Training Move
...
![b11-c08-g01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-g01-queen-target.png)
...
### b11-c08-m01 - Common Mistake: Missing The Diagram Signal
...
![b11-c08-m01](../../../chess-frontend/src/data/ebooks/v2/repertoire-model-games/assets/diagrams/b11-c08-m01-queen-target.png)
...
### b11-c08-q01 - Opening Mistakes And Punishments Check 1
...
```text
Opening Mistakes And Punishments Check 1
What should you do first in a position about **opening mistakes and punishments**?
```
...
### b11-c08-q02 - Opening Mistakes And Punishments Check 2
...
```text
Opening Mistakes And Punishments Check 2
Which answer best matches the chapter habit for **opening mistakes and punishments**?
```
...
### b11-c08-q03 - Opening Mistakes And Punishments Check 3
...
```text
Opening Mistakes And Punishments Check 3
What is the biggest danger if you ignore **opening mistakes and punishments**?
```
