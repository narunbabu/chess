...
Chapter: 02-pins
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/02-pins.json
Generated: 2026-05-05T07:36:03.682Z
...
Learning objectives:
- Recognize the visual signal for pins.
- Choose a move or plan that fits pins.
- Avoid the common beginner error connected with pins.
...
```text
Pins is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c02-d01 - Training Diagram: main pattern
...
![b03-c02-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-d01-back-rank.png)
...
### b03-c02-d02 - Training Diagram: candidate move
...
![b03-c02-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-d02-bishop-wins-rook.png)
...
### b03-c02-d03 - Training Diagram: comparison position
...
![b03-c02-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-d03-queen-target.png)
...
### b03-c02-d04 - Training Diagram: best practical choice
...
![b03-c02-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-d04-castle-safety.png)
...
### b03-c02-d05 - Training Diagram: review position
...
![b03-c02-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-d05-cct-check.png)
...
### b03-c02-g01 - Try It: Find The Training Move
...
![b03-c02-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-g01-back-rank.png)
...
### b03-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c02-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c02-m01-back-rank.png)
...
```text
Pins Check 1
What should you do first in a position about **pins**?
```
...
```text
Pins Check 2
Which answer best matches the chapter habit for **pins**?
```
...
```text
Pins Check 3
What is the biggest danger if you ignore **pins**?
```
