...
Chapter: 03-skewers
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/03-skewers.json
Generated: 2026-05-05T07:36:03.685Z
...
Learning objectives:
- Recognize the visual signal for skewers.
- Choose a move or plan that fits skewers.
- Avoid the common beginner error connected with skewers.
...
```text
Skewers is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c03-d01 - Training Diagram: main pattern
...
![b03-c03-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-d01-bishop-wins-rook.png)
...
### b03-c03-d02 - Training Diagram: candidate move
...
![b03-c03-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-d02-queen-target.png)
...
### b03-c03-d03 - Training Diagram: comparison position
...
![b03-c03-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-d03-castle-safety.png)
...
### b03-c03-d04 - Training Diagram: best practical choice
...
![b03-c03-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-d04-cct-check.png)
...
### b03-c03-d05 - Training Diagram: review position
...
![b03-c03-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-d05-rook-activity.png)
...
### b03-c03-g01 - Try It: Find The Training Move
...
![b03-c03-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-g01-bishop-wins-rook.png)
...
### b03-c03-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c03-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c03-m01-bishop-wins-rook.png)
...
```text
Skewers Check 1
What should you do first in a position about **skewers**?
```
...
```text
Skewers Check 2
Which answer best matches the chapter habit for **skewers**?
```
...
```text
Skewers Check 3
What is the biggest danger if you ignore **skewers**?
```
