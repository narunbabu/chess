# Review Pack: Deflection

Book: Beginner Tactics
Chapter: 07-deflection
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/07-deflection.json
Generated: 2026-05-05T07:36:03.700Z
...
Learning objectives:
- Recognize the visual signal for deflection.
- Choose a move or plan that fits deflection.
- Avoid the common beginner error connected with deflection.
...
```text
Deflection is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c07-d01 - Training Diagram: main pattern
...
![b03-c07-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-d01-rook-activity.png)
...
### b03-c07-d02 - Training Diagram: candidate move
...
![b03-c07-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-d02-king-pawn.png)
...
### b03-c07-d03 - Training Diagram: comparison position
...
![b03-c07-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-d03-quiet-king.png)
...
### b03-c07-d04 - Training Diagram: best practical choice
...
![b03-c07-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-d04-knight-fork.png)
...
### b03-c07-d05 - Training Diagram: review position
...
![b03-c07-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-d05-pin-file.png)
...
### b03-c07-g01 - Try It: Find The Training Move
...
![b03-c07-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-g01-rook-activity.png)
...
### b03-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c07-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c07-m01-rook-activity.png)
...
### b03-c07-q01 - Deflection Check 1
...
```text
Deflection Check 1
What should you do first in a position about **deflection**?
```
...
### b03-c07-q02 - Deflection Check 2
...
```text
Deflection Check 2
Which answer best matches the chapter habit for **deflection**?
```
...
### b03-c07-q03 - Deflection Check 3
...
```text
Deflection Check 3
What is the biggest danger if you ignore **deflection**?
```
