# Review Pack: Discovered Attacks

Book: Beginner Tactics
Chapter: 04-discovered-attacks
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/04-discovered-attacks.json
Generated: 2026-05-05T07:36:03.689Z
...
Learning objectives:
- Recognize the visual signal for discovered attacks.
- Choose a move or plan that fits discovered attacks.
- Avoid the common beginner error connected with discovered attacks.
...
```text
Discovered Attacks is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c04-d01 - Training Diagram: main pattern
...
![b03-c04-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-d01-queen-target.png)
...
### b03-c04-d02 - Training Diagram: candidate move
...
![b03-c04-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-d02-castle-safety.png)
...
### b03-c04-d03 - Training Diagram: comparison position
...
![b03-c04-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-d03-cct-check.png)
...
### b03-c04-d04 - Training Diagram: best practical choice
...
![b03-c04-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-d04-rook-activity.png)
...
### b03-c04-d05 - Training Diagram: review position
...
![b03-c04-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-d05-king-pawn.png)
...
### b03-c04-g01 - Try It: Find The Training Move
...
![b03-c04-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-g01-queen-target.png)
...
### b03-c04-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c04-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c04-m01-queen-target.png)
...
### b03-c04-q01 - Discovered Attacks Check 1
...
```text
Discovered Attacks Check 1
What should you do first in a position about **discovered attacks**?
```
...
### b03-c04-q02 - Discovered Attacks Check 2
...
```text
Discovered Attacks Check 2
Which answer best matches the chapter habit for **discovered attacks**?
```
...
### b03-c04-q03 - Discovered Attacks Check 3
...
```text
Discovered Attacks Check 3
What is the biggest danger if you ignore **discovered attacks**?
```
