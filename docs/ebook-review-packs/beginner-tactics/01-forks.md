...
Chapter: 01-forks
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/01-forks.json
Generated: 2026-05-05T07:36:03.678Z
...
Learning objectives:
- Recognize the visual signal for forks.
- Choose a move or plan that fits forks.
- Avoid the common beginner error connected with forks.
...
| tier_allowed <= silver | PASS | chapter tier is free |
...
```text
Forks is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c01-d01 - Training Diagram: main pattern
...
![b03-c01-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-d01-pin-file.png)
...
### b03-c01-d02 - Training Diagram: candidate move
...
![b03-c01-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-d02-back-rank.png)
...
### b03-c01-d03 - Training Diagram: comparison position
...
![b03-c01-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-d03-bishop-wins-rook.png)
...
### b03-c01-d04 - Training Diagram: best practical choice
...
![b03-c01-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-d04-queen-target.png)
...
### b03-c01-d05 - Training Diagram: review position
...
![b03-c01-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-d05-castle-safety.png)
...
### b03-c01-g01 - Try It: Find The Training Move
...
![b03-c01-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-g01-pin-file.png)
...
### b03-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c01-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c01-m01-pin-file.png)
...
```text
Forks Check 1
What should you do first in a position about **forks**?
```
...
```text
Forks Check 2
Which answer best matches the chapter habit for **forks**?
```
...
```text
Forks Check 3
What is the biggest danger if you ignore **forks**?
```
