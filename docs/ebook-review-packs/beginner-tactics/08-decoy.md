...
Chapter: 08-decoy
Source: ../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/chapters/08-decoy.json
Generated: 2026-05-05T07:36:03.703Z
...
Learning objectives:
- Recognize the visual signal for decoy.
- Choose a move or plan that fits decoy.
- Avoid the common beginner error connected with decoy.
...
```text
Decoy is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b03-c08-d01 - Training Diagram: main pattern
...
![b03-c08-d01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-d01-king-pawn.png)
...
### b03-c08-d02 - Training Diagram: candidate move
...
![b03-c08-d02](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-d02-quiet-king.png)
...
### b03-c08-d03 - Training Diagram: comparison position
...
![b03-c08-d03](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-d03-knight-fork.png)
...
### b03-c08-d04 - Training Diagram: best practical choice
...
![b03-c08-d04](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-d04-pin-file.png)
...
### b03-c08-d05 - Training Diagram: review position
...
![b03-c08-d05](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-d05-back-rank.png)
...
### b03-c08-g01 - Try It: Find The Training Move
...
![b03-c08-g01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-g01-king-pawn.png)
...
### b03-c08-m01 - Common Mistake: Missing The Diagram Signal
...
![b03-c08-m01](../../../chess-frontend/src/data/ebooks/v2/beginner-tactics/assets/diagrams/b03-c08-m01-king-pawn.png)
...
```text
Decoy Check 1
What should you do first in a position about **decoy**?
```
...
```text
Decoy Check 2
Which answer best matches the chapter habit for **decoy**?
```
...
```text
Decoy Check 3
What is the biggest danger if you ignore **decoy**?
```
