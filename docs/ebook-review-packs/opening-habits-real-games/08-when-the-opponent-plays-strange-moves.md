# Review Pack: When The Opponent Plays Strange Moves

Book: Opening Habits For Real Games
Chapter: 08-when-the-opponent-plays-strange-moves
Source: ../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/chapters/08-when-the-opponent-plays-strange-moves.json
Generated: 2026-05-05T07:36:03.896Z
...
Learning objectives:
- Recognize the visual signal for when the opponent plays strange moves.
- Choose a move or plan that fits when the opponent plays strange moves.
- Avoid the common beginner error connected with when the opponent plays strange moves.
...
```text
When The Opponent Plays Strange Moves is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b04-c08-d01 - Training Diagram: main pattern
...
![b04-c08-d01](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-d01-castle-safety.png)
...
### b04-c08-d02 - Training Diagram: candidate move
...
![b04-c08-d02](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-d02-cct-check.png)
...
### b04-c08-d03 - Training Diagram: comparison position
...
![b04-c08-d03](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-d03-rook-activity.png)
...
### b04-c08-d04 - Training Diagram: best practical choice
...
![b04-c08-d04](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-d04-king-pawn.png)
...
### b04-c08-d05 - Training Diagram: review position
...
![b04-c08-d05](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-d05-quiet-king.png)
...
### b04-c08-g01 - Try It: Find The Training Move
...
![b04-c08-g01](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-g01-castle-safety.png)
...
### b04-c08-m01 - Common Mistake: Missing The Diagram Signal
...
![b04-c08-m01](../../../chess-frontend/src/data/ebooks/v2/opening-habits-real-games/assets/diagrams/b04-c08-m01-castle-safety.png)
...
### b04-c08-q01 - When The Opponent Plays Strange Moves Check 1
...
```text
When The Opponent Plays Strange Moves Check 1
What should you do first in a position about **when the opponent plays strange moves**?
```
...
### b04-c08-q02 - When The Opponent Plays Strange Moves Check 2
...
```text
When The Opponent Plays Strange Moves Check 2
Which answer best matches the chapter habit for **when the opponent plays strange moves**?
```
...
### b04-c08-q03 - When The Opponent Plays Strange Moves Check 3
...
```text
When The Opponent Plays Strange Moves Check 3
What is the biggest danger if you ignore **when the opponent plays strange moves**?
```
