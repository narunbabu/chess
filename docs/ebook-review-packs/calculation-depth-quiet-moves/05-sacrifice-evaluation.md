# Review Pack: Sacrifice Evaluation

Book: Calculation II - Depth And Quiet Moves
Chapter: 05-sacrifice-evaluation
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/chapters/05-sacrifice-evaluation.json
Generated: 2026-05-05T07:36:03.767Z
...
Learning objectives:
- Recognize the visual signal for sacrifice evaluation.
- Choose a move or plan that fits sacrifice evaluation.
- Avoid the common beginner error connected with sacrifice evaluation.
...
```text
Sacrifice Evaluation is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b10-c05-d01 - Training Diagram: main pattern
...
![b10-c05-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-d01-queen-target.png)
...
### b10-c05-d02 - Training Diagram: candidate move
...
![b10-c05-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-d02-castle-safety.png)
...
### b10-c05-d03 - Training Diagram: comparison position
...
![b10-c05-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-d03-cct-check.png)
...
### b10-c05-d04 - Training Diagram: best practical choice
...
![b10-c05-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-d04-rook-activity.png)
...
### b10-c05-d05 - Training Diagram: review position
...
![b10-c05-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-d05-king-pawn.png)
...
### b10-c05-g01 - Try It: Find The Training Move
...
![b10-c05-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-g01-queen-target.png)
...
### b10-c05-m01 - Common Mistake: Missing The Diagram Signal
...
![b10-c05-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c05-m01-queen-target.png)
...
### b10-c05-q01 - Sacrifice Evaluation Check 1
...
```text
Sacrifice Evaluation Check 1
What should you do first in a position about **sacrifice evaluation**?
```
...
### b10-c05-q02 - Sacrifice Evaluation Check 2
...
```text
Sacrifice Evaluation Check 2
Which answer best matches the chapter habit for **sacrifice evaluation**?
```
...
### b10-c05-q03 - Sacrifice Evaluation Check 3
...
```text
Sacrifice Evaluation Check 3
What is the biggest danger if you ignore **sacrifice evaluation**?
```
