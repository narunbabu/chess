# Review Pack: Candidate Trees

Book: Calculation II - Depth And Quiet Moves
Chapter: 01-candidate-trees
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/chapters/01-candidate-trees.json
Generated: 2026-05-05T07:36:03.752Z
...
Learning objectives:
- Recognize the visual signal for candidate trees.
- Choose a move or plan that fits candidate trees.
- Avoid the common beginner error connected with candidate trees.
...
```text
Candidate Trees is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b10-c01-d01 - Training Diagram: main pattern
...
![b10-c01-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-d01-knight-fork.png)
...
### b10-c01-d02 - Training Diagram: candidate move
...
![b10-c01-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-d02-pin-file.png)
...
### b10-c01-d03 - Training Diagram: comparison position
...
![b10-c01-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-d03-back-rank.png)
...
### b10-c01-d04 - Training Diagram: best practical choice
...
![b10-c01-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-d04-bishop-wins-rook.png)
...
### b10-c01-d05 - Training Diagram: review position
...
![b10-c01-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-d05-queen-target.png)
...
### b10-c01-g01 - Try It: Find The Training Move
...
![b10-c01-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-g01-knight-fork.png)
...
### b10-c01-m01 - Common Mistake: Missing The Diagram Signal
...
![b10-c01-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c01-m01-knight-fork.png)
...
### b10-c01-q01 - Candidate Trees Check 1
...
```text
Candidate Trees Check 1
What should you do first in a position about **candidate trees**?
```
...
### b10-c01-q02 - Candidate Trees Check 2
...
```text
Candidate Trees Check 2
Which answer best matches the chapter habit for **candidate trees**?
```
...
### b10-c01-q03 - Candidate Trees Check 3
...
```text
Candidate Trees Check 3
What is the biggest danger if you ignore **candidate trees**?
```
