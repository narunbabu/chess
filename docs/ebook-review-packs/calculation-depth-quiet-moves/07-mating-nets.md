# Review Pack: Mating Nets

Book: Calculation II - Depth And Quiet Moves
Chapter: 07-mating-nets
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/chapters/07-mating-nets.json
Generated: 2026-05-05T07:36:03.775Z
...
Learning objectives:
- Recognize the visual signal for mating nets.
- Choose a move or plan that fits mating nets.
- Avoid the common beginner error connected with mating nets.
...
```text
Mating Nets is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b10-c07-d01 - Training Diagram: main pattern
...
![b10-c07-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-d01-cct-check.png)
...
### b10-c07-d02 - Training Diagram: candidate move
...
![b10-c07-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-d02-rook-activity.png)
...
### b10-c07-d03 - Training Diagram: comparison position
...
![b10-c07-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-d03-king-pawn.png)
...
### b10-c07-d04 - Training Diagram: best practical choice
...
![b10-c07-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-d04-quiet-king.png)
...
### b10-c07-d05 - Training Diagram: review position
...
![b10-c07-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-d05-knight-fork.png)
...
### b10-c07-g01 - Try It: Find The Training Move
...
![b10-c07-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-g01-cct-check.png)
...
### b10-c07-m01 - Common Mistake: Missing The Diagram Signal
...
![b10-c07-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c07-m01-cct-check.png)
...
### b10-c07-q01 - Mating Nets Check 1
...
```text
Mating Nets Check 1
What should you do first in a position about **mating nets**?
```
...
### b10-c07-q02 - Mating Nets Check 2
...
```text
Mating Nets Check 2
Which answer best matches the chapter habit for **mating nets**?
```
...
### b10-c07-q03 - Mating Nets Check 3
...
```text
Mating Nets Check 3
What is the biggest danger if you ignore **mating nets**?
```
