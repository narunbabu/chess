# Review Pack: Perpetual Check Awareness

Book: Calculation II - Depth And Quiet Moves
Chapter: 06-perpetual-check-awareness
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/chapters/06-perpetual-check-awareness.json
Generated: 2026-05-05T07:36:03.771Z
...
Learning objectives:
- Recognize the visual signal for perpetual check awareness.
- Choose a move or plan that fits perpetual check awareness.
- Avoid the common beginner error connected with perpetual check awareness.
...
```text
Perpetual Check Awareness is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b10-c06-d01 - Training Diagram: main pattern
...
![b10-c06-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-d01-castle-safety.png)
...
### b10-c06-d02 - Training Diagram: candidate move
...
![b10-c06-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-d02-cct-check.png)
...
### b10-c06-d03 - Training Diagram: comparison position
...
![b10-c06-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-d03-rook-activity.png)
...
### b10-c06-d04 - Training Diagram: best practical choice
...
![b10-c06-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-d04-king-pawn.png)
...
### b10-c06-d05 - Training Diagram: review position
...
![b10-c06-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-d05-quiet-king.png)
...
### b10-c06-g01 - Try It: Find The Training Move
...
![b10-c06-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-g01-castle-safety.png)
...
### b10-c06-m01 - Common Mistake: Missing The Diagram Signal
...
![b10-c06-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c06-m01-castle-safety.png)
...
### b10-c06-q01 - Perpetual Check Awareness Check 1
...
```text
Perpetual Check Awareness Check 1
What should you do first in a position about **perpetual check awareness**?
```
...
### b10-c06-q02 - Perpetual Check Awareness Check 2
...
```text
Perpetual Check Awareness Check 2
Which answer best matches the chapter habit for **perpetual check awareness**?
```
...
### b10-c06-q03 - Perpetual Check Awareness Check 3
...
```text
Perpetual Check Awareness Check 3
What is the biggest danger if you ignore **perpetual check awareness**?
```
