# Review Pack: Defensive Resources

Book: Calculation II - Depth And Quiet Moves
Chapter: 02-defensive-resources
Source: ../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/chapters/02-defensive-resources.json
Generated: 2026-05-05T07:36:03.756Z
...
Learning objectives:
- Recognize the visual signal for defensive resources.
- Choose a move or plan that fits defensive resources.
- Avoid the common beginner error connected with defensive resources.
...
```text
Defensive Resources is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b10-c02-d01 - Training Diagram: main pattern
...
![b10-c02-d01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-d01-pin-file.png)
...
### b10-c02-d02 - Training Diagram: candidate move
...
![b10-c02-d02](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-d02-back-rank.png)
...
### b10-c02-d03 - Training Diagram: comparison position
...
![b10-c02-d03](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-d03-bishop-wins-rook.png)
...
### b10-c02-d04 - Training Diagram: best practical choice
...
![b10-c02-d04](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-d04-queen-target.png)
...
### b10-c02-d05 - Training Diagram: review position
...
![b10-c02-d05](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-d05-castle-safety.png)
...
### b10-c02-g01 - Try It: Find The Training Move
...
![b10-c02-g01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-g01-pin-file.png)
...
### b10-c02-m01 - Common Mistake: Missing The Diagram Signal
...
![b10-c02-m01](../../../chess-frontend/src/data/ebooks/v2/calculation-depth-quiet-moves/assets/diagrams/b10-c02-m01-pin-file.png)
...
### b10-c02-q01 - Defensive Resources Check 1
...
```text
Defensive Resources Check 1
What should you do first in a position about **defensive resources**?
```
...
### b10-c02-q02 - Defensive Resources Check 2
...
```text
Defensive Resources Check 2
Which answer best matches the chapter habit for **defensive resources**?
```
...
### b10-c02-q03 - Defensive Resources Check 3
...
```text
Defensive Resources Check 3
What is the biggest danger if you ignore **defensive resources**?
```
