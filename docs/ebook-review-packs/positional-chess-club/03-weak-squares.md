# Review Pack: Weak Squares

Book: Positional Chess For Club Players
Chapter: 03-weak-squares
Source: ../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/chapters/03-weak-squares.json
Generated: 2026-05-05T07:36:03.914Z
...
Learning objectives:
- Recognize the visual signal for weak squares.
- Choose a move or plan that fits weak squares.
- Avoid the common beginner error connected with weak squares.
...
```text
Weak Squares is not a memory trick. It is a way to organize the position. First name the signal, then compare candidate moves, then choose the move that improves your position without creating a new weakness.
```

Reviewer flags: none from deterministic checks.

### b07-c03-d01 - Training Diagram: main pattern
...
![b07-c03-d01](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-d01-pin-file.png)
...
### b07-c03-d02 - Training Diagram: candidate move
...
![b07-c03-d02](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-d02-back-rank.png)
...
### b07-c03-d03 - Training Diagram: comparison position
...
![b07-c03-d03](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-d03-bishop-wins-rook.png)
...
### b07-c03-d04 - Training Diagram: best practical choice
...
![b07-c03-d04](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-d04-queen-target.png)
...
### b07-c03-d05 - Training Diagram: review position
...
![b07-c03-d05](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-d05-castle-safety.png)
...
### b07-c03-g01 - Try It: Find The Training Move
...
![b07-c03-g01](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-g01-pin-file.png)
...
### b07-c03-m01 - Common Mistake: Missing The Diagram Signal
...
![b07-c03-m01](../../../chess-frontend/src/data/ebooks/v2/positional-chess-club/assets/diagrams/b07-c03-m01-pin-file.png)
...
### b07-c03-q01 - Weak Squares Check 1
...
```text
Weak Squares Check 1
What should you do first in a position about **weak squares**?
```
...
### b07-c03-q02 - Weak Squares Check 2
...
```text
Weak Squares Check 2
Which answer best matches the chapter habit for **weak squares**?
```
...
### b07-c03-q03 - Weak Squares Check 3
...
```text
Weak Squares Check 3
What is the biggest danger if you ignore **weak squares**?
```
